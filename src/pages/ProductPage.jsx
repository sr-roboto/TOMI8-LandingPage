            ...
            <div className="mt-6 flex flex-col order-last lg:order-none ">
              ...
              >
                ...
                <div className="collapse-content text-base">
                  ...
                  simultáneamente hasta 80 dispositivos inteligentes y navegar
                  por el servidor de contenidos local. Gracias a su tecnología
                  de reconocimiento óptico permite escanear y procesar códigos
                  QR, automatizando el llamado a lista, facilitando el acceso a
                  encuestas, cuestionarios interactivos; así como la
                  calificación automática de tests con preguntas de selección
                  múltiple y la visualización de contenido de realidad
                  aumentada.
                </div>
              </div>
              <div
                    ...
                    <table className="flex-1 rounded-[5px] text-blue-black overflow-hidden">
                      <tbody>
                        ...
                        <tr className="bg-gray-200">
                          ...
                          <td className="py-4 px-2 md:px-3 lg:px-5">
                            GPU de video Mali con soporte de IA y códecs de
                            vídeo 8k
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr className="bg-gray-200">
                          ...
                          <td className="py-4 px-2 md:px-3 lg:px-5">
                            Chipset: RTL8821CU, USB2 0, 2,4 GHz + 5 GHz. 600
                            Mbps (11N: 150 Mbps, 11AC: 433 Mbps). IEEE 802.11AC…
                        ...
                        <tr>
                          ...
                          <td className="py-4 px-2 md:px-3 lg:px-5">
                            IEEE 802.11a/b/g/n/ac/ax WLAN 2.4 Ghz con velocidad
                            de hasta 573+1201 Mbps, CPU RISC de 32 bits de alto
              ...
              >
                ...
                <div className="collapse-content text-base flex flex-col gap-4 pt-6">
                  ...
                  >
                    ...
                    <div className="collapse-content text-base">
                      Sí! Gracias a su tecnología Bluetooth 4.2 y a sus puertos
                      de conexión de USB y HDMI, es posible conectar los
                      periféricos que se ajusten a las necesidades del usuario.
                    </div>
                  </div>
                  <div
                    className={`collapse collapse-plus bg-base-100 py-4 border border-[#A6A7B0] ${
                  ...
                  >
                    ...
                    <div className="collapse-content text-base">
                      ...
                      para navegar en el contenido que TOMi8 tiene pre-cargado
                      en su disco duro, ya sea del que tiene TOMi8 desde fábrica
                      o aquel que el maestro haya agregado desde la sección de
                  ...
                  >
                    ...
                    >
                      ¿Cuántos dispositivos de estudiantes se pueden conectar a
                      la red local del dispositivo TOMi8?
                    </div>
                    <div className="collapse-content text-base">
                      Es posible conectar simultáneamente hasta 80 dispositivos
                      inteligentes. Los estudiantes podrán conectar sus
                      tabletas, PC, portátiles y teléfonos inteligentes a TOMi8
                      para navegar en el servidor de contenido local o como
                  ...
                  >
                    ...
                    <div className="collapse-content text-base">
                      ...
                      que normalmente realizas en un computador, pero es mucho
                      más interactivo para ti y tus estudiantes, con
                      herramientas y funciones únicas.
                    </div>
                  </div>
                </div>
              </div>
